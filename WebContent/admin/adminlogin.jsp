...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
		     function checkeinfo(){
			     var message=document.getElementById("captcha").value;
				 if(message=="4854")return true;
				 else{
					 alert("验证码错误");
					 return false;
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/tologin.action" method="post" onsubmit="return checkeinfo()">
                        <ul>
